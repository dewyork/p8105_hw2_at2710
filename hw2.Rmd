...
# Problem 2
```{r problem_2}
Trash_Wheel <- readxl::read_excel("C:/Users/at2710/Downloads/HealthyHarborWaterWheelTotals2017-9-26 (1).xlsx",
        sheet = 'Mr. Trash Wheel', range = cell_cols("A:N")) %>% clean_names() %>% filter(!is.na(dumpster)) %>% 
  mutate(sports_balls = as.integer(round(sports_balls,0)))

Precip_2017 <- readxl::read_excel("C:/Users/at2710/Downloads/HealthyHarborWaterWheelTotals2017-9-26 (1).xlsx",
        sheet = '2017 Precipitation', range = "A2:B14") %>% filter(!is.na(Total)) %>% mutate(year = 2017)

Precip_2016 <- readxl::read_excel("C:/Users/at2710/Downloads/HealthyHarborWaterWheelTotals2017-9-26 (1).xlsx",
